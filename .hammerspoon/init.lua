...
hs.hotkey.bind(mash, '5', function () hs.application.launchOrFocus("Google Chrome") end)
hs.hotkey.bind(mash, '4', function () hs.application.launchOrFocus("Safari") end)
hs.hotkey.bind(mash, '3', function () hs.application.launchOrFocus("Sublime Text 2") end)
hs.hotkey.bind(mash, '2', function () hs.application.launchOrFocus("Slack") end)
